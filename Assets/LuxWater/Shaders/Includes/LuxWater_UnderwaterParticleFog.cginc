    ...
    //  Add ambient lighting to fog
        fogLighting += _Lux_UnderWaterFogColor * _Lux_UnderWaterAmbientSkyLight.rgb;
    ...
    fixed3 LuxWater_ParticleFog( fixed3 col, float4 fogLighting, float3 worldPos, float4 projPos ) {
    //  Underwater fog
        col = lerp(col, fogLighting.xyz, fogLighting.w);
    //  Absorption
