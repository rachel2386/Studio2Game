IMPORTANT TO READ updated for V1.7
...
There are Four different variations of CTAA for each platform PC, OCULUS ( Oculus SDK ), HTC VIVE ( OpenVR which supports both Oculus and VIVE ) and as of V1.6 CTAA SPS (SINGLE PASS STEREO, which can be used either with Oculus SDK or OpenVR/ STEAM VR SDK with Single Camera Setups)
