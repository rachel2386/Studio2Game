...
public class ShyFPSController : MonoBehaviour
{
    ...
    [SerializeField] private ShyMouseLook m_MouseLook;
    ...
    {
        m_MouseLook.BeginLitimationMode(to);
    }
    ...
    private void PlayFootStepAudio()
    {
        ...
        // move picked sound to index 0 so it's not picked next totalTimeInSeconds
